...
CREATE TABLE `estado_pagos` (
  ...
  CONSTRAINT `estado_pagos_ibfk_1` FOREIGN KEY (`ID_Residente`) REFERENCES `usuarios` (`ID_Usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `estado_pagos_ibfk_2` FOREIGN KEY (`ID_Reserva`) REFERENCES `reservas` (`ID_Reserva`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-02-11  6:48:27
